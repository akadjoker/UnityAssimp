...
public static class Assimp
{
    ...
    [DllImport("assimp.dll", CallingConvention = CallingConvention.StdCall)]
   ...
   public static extern void aiSetImportPropertyString(IntPtr pProps, string name, string value);
    ...
    [DllImport("assimp.dll", CallingConvention = CallingConvention.StdCall, EntryPoint = "aiMaterial_GetTexture", ExactSpelling = false)]
    ...
    [DllImport("assimp.dll", CallingConvention = CallingConvention.StdCall, EntryPoint = "aiMesh_GetName", ExactSpelling = false)]
    ...
    [DllImport("assimp.dll", CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
    ...
    [DllImport("assimp.dll", CallingConvention = CallingConvention.StdCall, EntryPoint = "aiMesh_GetBoneName", ExactSpelling = false)]
    ...
    [DllImport("assimp.dll", CallingConvention = CallingConvention.StdCall, EntryPoint = "aiAnim_GetName", ExactSpelling = false)]
    ...
    [DllImport("assimp.dll", CallingConvention = CallingConvention.StdCall, EntryPoint = "aiAnim_GetChannelName", ExactSpelling = false)]
    ...
    [DllImport("assimp.dll", CallingConvention = CallingConvention.StdCall, EntryPoint = "aiNode_GetName", ExactSpelling = false)]
